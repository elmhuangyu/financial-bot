...
2. **Standard Functional Modules**:
   ...
   - **Interactive Holdings Explorer**: Provide instant real-time keyword search, cross-account asset aggregation toggle (**Aggregate by Symbol / Merged View**), multi-field dropdown filters (Owner, Tax Treatment, Asset Class), column sorting (ascending/descending on click), and a dynamic total value/P&L footer.
