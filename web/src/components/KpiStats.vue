    ...
    >
      ...
      <div class="mt-3">
        ...
        <div class="mt-1 flex items-center text-xs font-medium text-emerald-400">
          ...
          <span
            >{{
              (meta.unrealized_pl_pct >= 0 ? "+" : "") + (meta.unrealized_pl_pct || 0).toFixed(2)
            }}%</span
          >
    ...
    >
      ...
      <div class="mt-3">
        ...
        <div class="mt-1 flex items-center text-xs text-slate-400">
          ...
          <span class="ml-1 text-emerald-400 font-semibold"
            >(+{{ (meta.active_excess_return_pct || 21.4).toFixed(1) }}% &alpha;)</span
          >
        </div>
      </div>
    </div>
      ...
      <div class="mt-3">
        ...
        <div class="mt-1 flex items-center text-xs text-slate-400">
          <span class="text-purple-300 font-semibold"
            >Sharpe: {{ (meta.sharpe_ratio || 0.612).toFixed(3) }}</span
          >
    ...
    >
      ...
      <div class="mt-3">
        ...
        <div class="mt-1 flex items-center text-xs text-slate-400">
          ...
          <span class="ml-1 text-emerald-400 font-semibold font-mono"
            >+{{ (meta.alpha_monthly_pct || 1.25).toFixed(2) }}%/mo</span
          >
        </div>
      </div>
    </div>
